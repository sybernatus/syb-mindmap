...
impl Link {
    ...
    pub fn compute_control_points_offset(self, offset_ratio: f32) -> (Pos2, Pos2) {
        ...
        let control_point1 = Pos2 {
            x: self.pos_start.x + direction_x / 3.0 + normal_x + normal_x / 3.0 * distance * offset_ratio,
            y: self.pos_start.y + direction_y / 3.0 + normal_y + normal_y / 3.0 * distance * offset_ratio,
        };

        let control_point2 = Pos2 {
            x: self.pos_start.x + direction_x - direction_x / 6.0 - normal_x - normal_x / 6.0 * distance * offset_ratio,
            y: self.pos_start.y + direction_y - direction_y / 6.0 - normal_y - normal_y / 6.0 * distance * offset_ratio,
        };
